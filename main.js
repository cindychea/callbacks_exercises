...
*/
const bigSpenders = transactions.filter(transaction => transaction.type == 'sale' && transaction.items.length > 4).map(transaction => {
...
*/
const netProfit = transactions.map(transaction => transaction.items).flat().reduce(((total, item) => total + item.price), 0);
...
*/
const mostItems = transactions.filter(transaction => transaction.type == 'sale').map(transaction => transaction.items.length).sort((a, b) => b-a)[0];
...
*/
// smallestPurchase = transactions.filter(transaction => transaction.type == 'purchase').map(transaction => transaction.items.length).sort()[0]
// const sumOfSmallestPurchase = transactions.filter(transaction => transaction.type == 'purchase' && transaction.items.length == smallestPurchase).map(transaction => transaction.items.map(item => item.price)).flat().reduce(((total, price) => total + price), 0);
const sumOfSmallestPurchase = transactions.filter(transaction => transaction.type == 'purchase' && transaction.items.length == transactions.filter(transaction => transaction.type == 'purchase').map(transaction => transaction.items.length).sort()[0]).map(transaction => transaction.items.map(item => item.price)).flat().reduce(((total, price) => total + price), 0);
